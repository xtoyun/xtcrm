...
![销售页](docs/images/销售页.png)

### 知识库

产品知识、销售话术、竞品对比、成功案例。

![知识库页](docs/images/知识库页.png)

### 应用中心

已安装技能包（报价、发票、内容引擎等）。

![应用页](docs/images/应用页.png)

### 系统设置

用户、角色、部门、菜单权限管理。

![系统设置页](docs/images/系统设置页.png)

### CRM 设置

租户级参数：公海规则、洞察阈值、跟进提醒等。

![CRM设置页](docs/images/CRM设置页.png)

### AI 设置

内容引擎 Agent 配置、预设管理、变量定义。

![AI设置页](docs/images/AI设置页.png)
...
![联系二维码](docs/images/联系二维码.png)

### 赞助支持

如果这个项目对你有帮助，欢迎请作者喝杯咖啡 ☕

![赞助二维码](docs/images/赞助二维码.png)
...
本项目采用 **Apache License 2.0** 协议开源。完整协议文本见 [LICENSE](LICENSE)。
...
分发或部署本软件时，需保留 [NOTICE](NOTICE) 文件中的归属信息。衍生作品可在 NOTICE 中添加你自己的归属，但不得删除原始声明。

### 社区治理

本项目采用 [单一维护者 + 社区贡献](GOVERNANCE.md) 的治理模型。核心文档：

| 文档 | 用途 |
|------|------|
| [GOVERNANCE.md](GOVERNANCE.md) | 角色定义、决策流程、晋升机制 |
| [CONTRIBUTING.md](CONTRIBUTING.md) | 如何参与贡献（编码规范、PR 流程） |
| [SECURITY.md](SECURITY.md) | 安全漏洞报告、响应时效 |
| [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md) | 社区行为准则（Contributor Covenant 2.0） |
